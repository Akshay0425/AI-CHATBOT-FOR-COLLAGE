...
:root {
  ...
  --secondary-foreground: oklch(0.85 0.18 90);
  --muted: oklch(0.95 0.01 90);
  --muted-foreground: oklch(0.4 0 0);
  --accent: oklch(0.75 0.16 90);
  --accent-foreground: oklch(0.15 0 0);
  --destructive: oklch(0.577 0.245 27.325);
  --destructive-foreground: oklch(0.577 0.245 27.325);
  --border: oklch(0.88 0.04 90);
  --input: oklch(0.92 0.02 90);
  --ring: oklch(0.75 0.16 90);
  --chart-1: oklch(0.85 0.18 90);
  --chart-2: oklch(0.75 0.16 90);
  --chart-3: oklch(0.25 0 0);
  --chart-4: oklch(0.65 0.14 90);
  --chart-5: oklch(0.55 0.12 90);
  --radius: 0.75rem;
  ...
  --sidebar-ring: oklch(0.75 0.16 90);
}
